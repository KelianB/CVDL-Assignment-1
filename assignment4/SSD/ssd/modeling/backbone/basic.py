...
class BasicModel(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # Custom backbone
        self.feature_bank_extractors = []
        self.feature_bank_extractors.append(nn.Sequential(
        ...
        self.feature_bank_extractors = torch_utils.to_cuda(self.feature_bank_extractors)
